class Event < ActiveRecord::Base
  ...
  enum rating_phase: { wait_users: 0, starting: 1, knockout_match: 2 }  
  enum voting_range: { one_to_five: 0, one_to_ten: 1, up_down: 2 }   
  enum event_status: { waiting_others: 0, confirm: 1, add_movies: 2, vote: 3, knockout_choose: 4, winner: 5, finished: 6, declined: 7, failed: 8 } 
