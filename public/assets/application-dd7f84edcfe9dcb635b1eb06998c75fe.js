...
(function() {
  $(document).ready(function() {
    $(".update_watched").on("ajax:success", function(e, data, status, xhr) {
      var json_data;
      json_data = JSON.parse(xhr.responseText);
      if (json_data.movie_id) {
        if (json_data.watched === true) {
          $("#watched_img_above_" + json_data.movie_id).attr('src', '/assets/watched.png');
          return $("#watched_img_" + json_data.movie_id).attr('src', '/assets/watched_remove.png');
        } else {
          $("#watched_img_" + json_data.movie_id).attr('src', '/assets/watched_add.png');
          return $("#watched_img_above_" + json_data.movie_id).attr('src', '');
        }
      } else {
        $("#watched_img_" + json_data.movie_id).attr('src', '/assets/watched_add.png');
        return $("#watched_img_above_" + json_data.movie_id).attr('src', '');
    ...
    $(".update_collected").on("ajax:success", function(e, data, status, xhr) {
      var json_data;
      json_data = JSON.parse(xhr.responseText);
      if (json_data.movie_id) {
        if (json_data.collection === true) {
          $("#collected_img_above_" + json_data.movie_id).attr('src', '/assets/collected.png');
          return $("#collected_img_" + json_data.movie_id).attr('src', '/assets/collected_remove.png');
        } else {
          $("#collected_img_" + json_data.movie_id).attr('src', '/assets/collected_add.png');
          return $("#collected_img_above_" + json_data.movie_id).attr('src', '');
        }
      } else {
        $("#collected_img_" + json_data.movie_id).attr('src', '/assets/collected_add.png');
        return $("#collected_img_above_" + json_data.movie_id).attr('src', '');
    ...
    return $(".update_watchlist").on("ajax:success", function(e, data, status, xhr) {
      var json_data;
      json_data = JSON.parse(xhr.responseText);
      if (json_data.movie_id) {
        if (json_data.watchlist === true) {
          $("#watchlist_img_above_" + json_data.movie_id).attr('src', '/assets/watchlist.png');
          return $("#watchlist_img_" + json_data.movie_id).attr('src', '/assets/watchlist_remove.png');
        } else {
          $("#watchlist_img_" + json_data.movie_id).attr('src', '/assets/watchlist_add.png');
          return $("#watchlist_img_above_" + json_data.movie_id).attr('src', '');
        }
      } else {
        $("#watchlist_img_" + json_data.movie_id).attr('src', '/assets/watchlist_add.png');
        return $("#watchlist_img_above_" + json_data.movie_id).attr('src', '');
